...
export default class API {
    ...
    static createConversation = async (workspaceUrl, token, experienceShortCode) => {
    ...
    static updateFcmToken = async (workspaceUrl, fcmToken, authToken, androidNotificationChannel) => {
    ...
    static updateAPNSToken = async (workspaceUrl, apnsToken, authToken) => {
        const url = workspaceUrl + 'user-service/user/add_contact_apns_device_token'
    ...
    static updateJPushRegistrationID = async (workspaceUrl, registrationId, authToken, androidNotificationChannel) => {
        const url = workspaceUrl + 'user-service/user/add_contact_jpush_device_token'
